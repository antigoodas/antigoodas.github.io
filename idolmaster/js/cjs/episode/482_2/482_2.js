...
(lib.bg = function() {
	this.initialize(img._482_2_bg);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1020,1400);


(lib.book = function() {
	this.initialize(img._482_2_book);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,894,536);


(lib.ch_base = function() {
	this.initialize(img._482_2_ch_base);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,1020,1400);


(lib.ch_face2 = function() {
	this.initialize(img._482_2_ch_face2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face3 = function() {
	this.initialize(img._482_2_ch_face3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face4 = function() {
	this.initialize(img._482_2_ch_face4);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face5 = function() {
	this.initialize(img._482_2_ch_face5);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face6 = function() {
	this.initialize(img._482_2_ch_face6);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face7 = function() {
	this.initialize(img._482_2_ch_face7);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face8 = function() {
	this.initialize(img._482_2_ch_face8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.ch_face9 = function() {
	this.initialize(img._482_2_ch_face9);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,240);


(lib.finish = function() {
	this.initialize(img._482_2_finish);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.finish_blur = function() {
	this.initialize(img._482_2_finish_blur);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,480,620);


(lib.tie_fp = function() {
	this.initialize(img._482_2_tie_fp);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,240,32);


(lib.tie_sp = function() {
	this.initialize(img._482_2_tie_sp);
}).prototype = p = new cjs.Bitmap();
...
}).prototype = getMCSymbolPrototype(lib.character1_face_eyeclose, new cjs.Rectangle(0,0,120,120), null);
...
}).prototype = getMCSymbolPrototype(lib.character1_base, new cjs.Rectangle(-120,-396,510,700), null);
...
(lib.book_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-223.5,-134,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.book_1, new cjs.Rectangle(-223.5,-134,447,268), null);
...
p.nominalBounds = new cjs.Rectangle(0,0,510,700);
...
(lib.tie = function(mode,startPosition,loop) {
	...
	// txt
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#333333").s().p("");
	this.shape.setTransform(24,0.125);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AAsBMIAAgJIhXAAIAAAJIgRAAIAAiAIAmAAIAFgJIAFgOIASAFIgFAKIgEAIIBAAAIAACAgAgrAzIBXAAIAAgVIhXAAgAgrAQIBXAAIAAgUIhXAAgAgrgRIBXAAIAAgTIhXAAg");
	...
	this.shape_2.setTransform(-7.875,0.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("");
	this.shape_3.setTransform(-23.8,0.425);
...
(lib.character1_face = function(mode,startPosition,loop) {
	...
	mask._off = true;
	mask.graphics.p("ApNJOIAAybISbAAIAASbg");
	mask.setTransform(60,60);

	// face
	this.instance = new lib.ch_face2();
	this.instance.parent = this;
	this.instance.setTransform(0,0,0.5,0.5);

	this.instance_1 = new lib.ch_face3();
	this.instance_1.parent = this;
	...
	this.instance_3 = new lib.ch_face5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(0,0,0.5,0.5);

	this.instance_4 = new lib.ch_face6();
	this.instance_4.parent = this;
	this.instance_4.setTransform(0,0,0.5,0.5);

	this.instance_5 = new lib.ch_face7();
	this.instance_5.parent = this;
	this.instance_5.setTransform(0,0,0.5,0.5);

	this.instance_6 = new lib.ch_face8();
	this.instance_6.parent = this;
	this.instance_6.setTransform(0,0,0.5,0.5);

	this.instance_7 = new lib.ch_face9();
	this.instance_7.parent = this;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).wait(11));

	// body
	this.b = new lib.character1_base();
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-92,224);
...
p.nominalBounds = new cjs.Rectangle(1,1,118,118);
...
(lib.character1_face_container = function(mode,startPosition,loop) {
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_15 = new cjs.Graphics().p("AoOBcQDkj2CsDaQBRAKBVgyQgwkZH2gUQBJBxhZCLQkgCJhohQQiuAigXAiQAVBZkSBZQh4hJgqhxg");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(15).to({graphics:mask_graphics_15,x:62.11,y:49.1875}).wait(6).to({graphics:mask_graphics_21,x:31.25,y:41.8}).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(15).to({_off:false},0).wait(1).to({alpha:1},0).wait(1).to({regX:60,regY:60,x:60,y:60,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2).to({alpha:0.1992},0).wait(1).to({alpha:1},0).wait(1).to({regX:60,regY:60,x:60,y:60,alpha:0.3015},0).wait(1).to({alpha:0.0922},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.f2).wait(5).to({alpha:0.1992},0).wait(1).to({regX:60,regY:60,x:60,y:60,alpha:0.6441},0).wait(1).to({alpha:0.911},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:1},0).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.f1_alpha).wait(5).to({alpha:0.8008},0).wait(1).to({regX:60,regY:60,x:60,y:60,alpha:0.7118},0).wait(1).to({alpha:0.4449},0).wait(1).to({regX:35,regY:30,x:35,y:30,alpha:0},0).wait(19));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-212,-172,510,700);
...
(lib.character1_body = function(mode,startPosition,loop) {
	...
	this.f.name = "f";
	this.f.parent = this;
	this.f.setTransform(-32.65,-365.9);
	...
	this.b.name = "b";
	this.b.parent = this;
	this.b.setTransform(-124.65,-141.9);

	this.timeline.addTween(cjs.Tween.get(this.b).wait(2));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-244.6,-537.9,554.8,700);
...
(lib.character1_container = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{standby:0,jump:8,jump2:18,jump_double:27,jump_flower:39,jump_flower2:49,nod:59,nod2:68,nod_double:83,swing:104,swing_on:124,swing_off:142,notice:159,notice_jump:173,laugh:187,chord:208,question:228,question_on:256,question_off:268,exclamation:279,down:295,down2:322,shy_jump:340,shy_down:352,shock:370,sigh:377,happy:396,anger:411,anger2:431,damage:443,concent:460,swing2:469});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(7).call(this.frame_7).wait(1).call(this.frame_8).wait(9).call(this.frame_17).wait(1).call(this.frame_18).wait(8).call(this.frame_26).wait(1).call(this.frame_27).wait(11).call(this.frame_38).wait(1).call(this.frame_39).wait(9).call(this.frame_48).wait(1).call(this.frame_49).wait(9).call(this.frame_58).wait(1).call(this.frame_59).wait(8).call(this.frame_67).wait(1).call(this.frame_68).wait(14).call(this.frame_82).wait(1).call(this.frame_83).wait(20).call(this.frame_103).wait(1).call(this.frame_104).wait(19).call(this.frame_123).wait(1).call(this.frame_124).wait(17).call(this.frame_141).wait(1).call(this.frame_142).wait(16).call(this.frame_158).wait(1).call(this.frame_159).wait(13).call(this.frame_172).wait(1).call(this.frame_173).wait(13).call(this.frame_186).wait(1).call(this.frame_187).wait(20).call(this.frame_207).wait(1).call(this.frame_208).wait(19).call(this.frame_227).wait(1).call(this.frame_228).wait(27).call(this.frame_255).wait(1).call(this.frame_256).wait(11).call(this.frame_267).wait(1).call(this.frame_268).wait(10).call(this.frame_278).wait(1).call(this.frame_279).wait(15).call(this.frame_294).wait(1).call(this.frame_295).wait(26).call(this.frame_321).wait(1).call(this.frame_322).wait(17).call(this.frame_339).wait(1).call(this.frame_340).wait(11).call(this.frame_351).wait(1).call(this.frame_352).wait(17).call(this.frame_369).wait(1).call(this.frame_370).wait(6).call(this.frame_376).wait(1).call(this.frame_377).wait(18).call(this.frame_395).wait(1).call(this.frame_396).wait(14).call(this.frame_410).wait(1).call(this.frame_411).wait(19).call(this.frame_430).wait(1).call(this.frame_431).wait(11).call(this.frame_442).wait(1).call(this.frame_443).wait(16).call(this.frame_459).wait(1).call(this.frame_460).wait(8).call(this.frame_468).wait(1).call(this.frame_469).wait(19).call(this.frame_488).wait(1));

	// effect2
	this.instance = new lib.drop1_v2("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-60.25,-402.1,1.1645,1.1645);
	this.instance._off = true;

	this.instance_1 = new lib.heart();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-40.05,-351.2,0.4532,0.4532);
	this.instance_1.alpha = 0;
	this.instance_1.compositeOperation = "lighter";
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(340).to({_off:false},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-85.85,y:-411.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-97.5,y:-415.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-60.25,y:-402.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-85.85,y:-411.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-97.5,y:-415.4,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,rotation:0,x:-60.25,y:-402.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-85.85,y:-411.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-97.5,y:-415.4,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,rotation:0,x:-60.25,y:-402.1,alpha:1},0).wait(1).to({regX:1.2,regY:1.8,rotation:-33.7496,x:-85.85,y:-411.1,alpha:0.4141},0).wait(1).to({regX:0,regY:0,rotation:-44.9995,x:-97.5,y:-415.4,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(397).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-41.8,y:-365.35,alpha:0.375},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-45.05,y:-371.2,alpha:0.5},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-42.5,y:-369.05,alpha:0.4444},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-41.95,y:-365.8,alpha:0.2778},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-43.05,y:-361.2,alpha:0},0).to({_off:true},1).wait(86));

	// effect
	this.instance_2 = new lib.spread_flower_pink("synched",0,false);
	this.instance_2.parent = this;
	this.instance_2.setTransform(24.8,-307.95,1.4808,1.4808);

	this.instance_3 = new lib.good_effect("synched",0,false);
	this.instance_3.parent = this;
	this.instance_3.setTransform(24.8,-307.95,1.481,1.481);

	this.instance_4 = new lib.notice();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-65.8,-388.55,1.187,1.187,0,-169.8305,10.1695,-29.1,20.4);
	this.instance_4._off = true;

	this.instance_5 = new lib.laugh("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(-67.65,-392.6,1.4204,1.4204,35.8424,0,0,-30.2,20.6);
	this.instance_5._off = true;

	this.instance_6 = new lib.chord("synched",0,false);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-57.75,-301.65,0.7989,0.7989,-61.4578,0,0,-23.4,76.5);

	this.instance_7 = new lib.question();
	this.instance_7.parent = this;
	this.instance_7.setTransform(-40.65,-394.95,1.053,1.053,-28.4906);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.instance_8 = new lib.mc_exclamation("synched",0,false);
	this.instance_8.parent = this;
	this.instance_8.setTransform(-61.8,-381.3,1.0929,1.0929,-29.9996,0,0,0,0.1);

	this.instance_9 = new lib.drop1a("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(57.1,-400.5,1,1,0,0,0,-0.5,0.2);
	this.instance_9._off = true;

	this.instance_10 = new lib.drop2_v2("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-62.05,-392.35,0.9876,0.9876,14.9998);
	this.instance_10._off = true;

	this.instance_11 = new lib.shock("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(-59.75,-386.5,1.3878,1.3878,-121.2396);

	this.instance_12 = new lib.sigh("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(10.1,-241.6);
	this.instance_12.alpha = 0.6016;
	this.instance_12._off = true;

	this.instance_13 = new lib.heart("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(-40.05,-351.2,0.4532,0.4532);
	this.instance_13._off = true;

	this.instance_14 = new lib.angry("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(97.9,-371.3,0.5276,0.5276);
	this.instance_14._off = true;

	this.instance_15 = new lib.mc_punpun();
	this.instance_15.parent = this;
	this.instance_15.setTransform(-33.15,-420.45,1.1377,1.1377);

	this.instance_16 = new lib.concent_wrapper("synched",0,false);
	this.instance_16.parent = this;
	this.instance_16.setTransform(24.55,-308.5,1,1,0,0,0,-0.5,-0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},39).to({state:[{t:this.instance_3}]},10).to({state:[]},10).to({state:[{t:this.instance_4}]},101).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_4}]},2).to({state:[]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},2).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},15).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_5}]},1).to({state:[]},1).to({state:[{t:this.instance_6}]},1).to({state:[]},20).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},7).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_7}]},6).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},2).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_7}]},1).to({state:[]},1).to({state:[{t:this.instance_8}]},5).to({state:[{t:this.instance_9}]},16).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},9).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_9}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},24).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},5).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_10}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},11).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_11}]},1).to({state:[]},1).to({state:[{t:this.instance_12}]},3).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_12}]},1).to({state:[]},1).to({state:[{t:this.instance_13}]},11).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},2).to({state:[{t:this.instance_13}]},3).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_13}]},1).to({state:[]},1).to({state:[{t:this.instance_14}]},6).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},5).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_14}]},1).to({state:[]},1).to({state:[{t:this.instance_15}]},2).to({state:[]},12).to({state:[{t:this.instance_16}]},17).to({state:[]},9).wait(20));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-65.4,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-65.8,alpha:0},0).to({_off:true},1).wait(2).to({_off:false,alpha:1},0).to({_off:true},2).wait(1).to({_off:false},0).wait(3).to({regX:-28.8,regY:20.5,x:-65.4,alpha:0.6944},0).wait(1).to({alpha:0.4444},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.1111},0).wait(1).to({alpha:0.0278},0).wait(1).to({regX:-29.1,regY:20.4,x:-65.8,alpha:0},0).to({_off:true},1).wait(303));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(187).to({_off:false},0).wait(15).to({startPosition:0},0).wait(1).to({regX:-31.4,regY:22.1,scaleX:1.4203,scaleY:1.4203,x:-70.3,y:-391.85,alpha:0.5625,startPosition:1},0).wait(1).to({alpha:0.25,startPosition:2},0).wait(1).to({alpha:0.0625,startPosition:3},0).wait(1).to({regX:-30.2,regY:20.6,scaleX:1.4204,scaleY:1.4204,x:-67.65,y:-392.6,alpha:0,startPosition:19},0).to({_off:true},1).wait(282));
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(229).to({_off:false},0).wait(1).to({regX:-0.2,regY:0.2,x:-47.6,y:-408.35,alpha:0.5556},0).wait(1).to({x:-51.7,y:-416.6,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-53,y:-419.65,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-52.75,y:-418.7},0).wait(1).to({x:-51.75,y:-416.85},0).wait(1).to({x:-50.05,y:-413.7},0).wait(1).to({regX:0,regY:0,x:-47.6,y:-409.65},0).to({x:-48.35,y:-411},2).wait(8).to({regX:-0.2,regY:0.2,x:-48.1,y:-410.1,alpha:0.9298},0).wait(1).to({x:-47.05,y:-408.15,alpha:0.692},0).wait(1).to({x:-45.45,y:-405.25,alpha:0.339},0).wait(1).to({x:-44.3,y:-403.1,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-43.85,y:-402.8,alpha:0},0).to({_off:true},1).wait(6).to({_off:false,x:-60,y:-366.2},0).wait(1).to({regX:-0.2,regY:0.2,x:-66.95,y:-379.6,alpha:0.5556},0).wait(1).to({x:-71.05,y:-387.85,alpha:0.8889},0).wait(1).to({regX:0,regY:0,x:-72.35,y:-390.9,alpha:1},0).wait(1).to({regX:-0.2,regY:0.2,x:-72.1,y:-389.95},0).wait(1).to({x:-71.1,y:-388.1},0).wait(1).to({x:-69.4,y:-384.95},0).wait(1).to({regX:0,regY:0,x:-66.95,y:-380.9},0).to({x:-67.7,y:-382.25},2).wait(3).to({regX:-0.2,regY:0.2,x:-67.45,y:-381.35,alpha:0.9298},0).wait(1).to({x:-66.4,y:-379.4,alpha:0.692},0).wait(1).to({x:-64.8,y:-376.5,alpha:0.339},0).wait(1).to({x:-63.65,y:-374.35,alpha:0.0788},0).wait(1).to({regX:0,regY:0,x:-63.2,y:-374.05,alpha:0},0).to({_off:true},1).wait(215));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(295).to({_off:false},0).wait(1).to({regX:0.5,regY:-0.6,x:58.1,y:-396.8},0).wait(1).to({y:-392.95},0).wait(1).to({y:-389.7},0).wait(1).to({y:-387.05},0).wait(1).to({y:-384.95},0).wait(1).to({y:-383.45},0).wait(1).to({y:-382.55},0).wait(1).to({regX:-0.5,regY:0.2,x:57.1,y:-381.5},0).wait(9).to({startPosition:0},0).wait(1).to({regX:0.5,regY:-0.6,x:58.1,y:-382.3,alpha:0.4444},0).wait(1).to({alpha:0.1111},0).wait(1).to({regX:-0.5,regY:0.2,x:57.1,y:-381.5,alpha:0},0).to({_off:true},1).wait(173));
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(340).to({_off:false},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-93.475,y:-387.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-103.95,y:-386.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-62.05,y:-392.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-93.475,y:-392.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-103.95,y:-392.05,alpha:0.2188},0).to({_off:true},1).wait(5).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-62.05,y:-392.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-93.475,y:-387.7375,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-103.95,y:-386.2,alpha:0.2188},0).to({_off:true},1).wait(1).to({_off:false,scaleX:0.9876,scaleY:0.9876,rotation:14.9998,x:-62.05,y:-392.35,alpha:1},0).wait(1).to({scaleX:1.1203,scaleY:1.1203,rotation:-18.7494,x:-93.475,y:-392.125,alpha:0.4141},0).wait(1).to({scaleX:1.1645,scaleY:1.1645,rotation:-29.9991,x:-103.95,y:-392.05,alpha:0.2188},0).to({_off:true},1).wait(130));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(378).to({_off:false},0).wait(1).to({x:9.1,y:-240.6,alpha:1},0).wait(1).to({regX:0.9,x:8.95,y:-239.65,alpha:0.8965},0).wait(1).to({x:7.6,y:-238.45,alpha:0.7636},0).wait(1).to({x:6,y:-237,alpha:0.6048},0).wait(1).to({x:4.2,y:-235.4,alpha:0.4229},0).wait(1).to({x:2.2,y:-233.55,alpha:0.2205},0).wait(1).to({regX:0,x:-0.9,y:-231.6,alpha:0},0).to({_off:true},1).wait(103));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(397).to({_off:false},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8633,scaleY:0.8633,x:-41.8,y:-365.35},0).wait(1).to({regX:0,regY:0,scaleX:1,scaleY:1,x:-45.05,y:-371.2},0).wait(1).to({regX:2.3,regY:1,scaleX:0.9896,scaleY:0.9896,x:-42.5,y:-369.05},0).wait(1).to({scaleX:0.9586,scaleY:0.9586,x:-41.95,y:-365.8},0).wait(1).to({regX:0,regY:0,scaleX:0.9068,scaleY:0.9068,x:-43.05,y:-361.2},0).to({scaleX:1,scaleY:1,x:-44.05,y:-365.2},2).wait(3).to({scaleX:1.1165,scaleY:1.1165},0).wait(1).to({regX:2.3,regY:1,scaleX:0.8111,scaleY:0.8111,x:-41.45,y:-364.2,alpha:0.3262},0).wait(1).to({regX:0,regY:0,scaleX:0.7092,scaleY:0.7092,x:-43.05,y:-364.95,alpha:0.1016},0).to({_off:true},1).wait(79));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(416).to({_off:false},0).wait(1).to({scaleX:1.0714,scaleY:1.0714,y:-375.05},0).wait(1).to({scaleX:1.2527,scaleY:1.2527,y:-376.3},0).wait(1).to({scaleX:0.9864,scaleY:0.9864},0).wait(1).to({scaleX:0.8976,scaleY:0.8976},0).wait(5).to({startPosition:0},0).wait(1).to({alpha:0.5009},0).wait(1).to({alpha:0.2014},0).wait(1).to({alpha:0.1016},0).to({_off:true},1).wait(60));

	// book
	this.instance_17 = new lib.book_1();
	this.instance_17.parent = this;
	this.instance_17.setTransform(-21.15,28.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(489));
	...
	this.timeline.addTween(cjs.Tween.get(this.c).wait(9).to({regX:10.4,regY:-187.9,x:10.4,y:-190.1},0).wait(1).to({regX:0,regY:0,x:0,y:-3.15},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-191.5},0).wait(1).to({regX:0,regY:0,x:0,y:-3.75},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-191.2},0).wait(1).to({y:-189.8},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).to({y:0},2).wait(1).to({y:2},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-193.4},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-193.65},0).wait(1).to({y:-186.7},0).wait(1).to({regX:0,regY:0,x:0,y:4},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-184.65},0).wait(1).to({y:-187.05},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:0.4},0).wait(1).to({y:-2.6},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-189.85},0).wait(1).to({y:-188.1},0).wait(1).to({regX:0,regY:0,x:0,y:0.4},0).wait(1).to({y:-2.6},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-189.8},0).wait(1).to({y:-187.95},0).wait(1).to({regX:0,regY:0,x:0,y:0.6},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-187.75},0).wait(1).to({y:-187.85},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(22).to({regX:10.4,regY:-187.9,x:10.4,y:-187.7},0).wait(1).to({y:-186.8},0).wait(1).to({y:-185.9},0).wait(1).to({regX:0,regY:0,x:0,y:2.25},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-185.9},0).wait(1).to({y:-186.8},0).wait(1).to({y:-187.7},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,x:10.4,y:-187.75},0).wait(1).to({y:-187.2},0).wait(1).to({y:-186.1},0).wait(1).to({y:-184.75},0).wait(1).to({y:-183.65},0).wait(1).to({y:-183.1},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-183.1},0).wait(1).to({y:-183.65},0).wait(1).to({y:-184.75},0).wait(1).to({y:-186.1},0).wait(1).to({y:-187.2},0).wait(1).to({y:-187.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regY:0.2,scaleX:0.9999,scaleY:0.9999,rotation:-0.2885,y:0.75},5).wait(1).to({regX:10.4,regY:-187.9,rotation:-0.2699,x:9.5,y:-187.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.1994,x:9.75,y:-187.65},0).wait(1).to({rotation:-0.0891,x:10.1,y:-187.9},0).wait(1).to({rotation:-0.0186,x:10.35,y:-188.05},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).to({regY:0.2,scaleX:0.9999,scaleY:0.9999,rotation:-0.2885,y:0.75},5).wait(1).to({regX:10.4,regY:-187.9,rotation:-0.2699,x:9.5,y:-187.45},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.1994,x:9.75,y:-187.65},0).wait(1).to({rotation:-0.0891,x:10.1,y:-187.9},0).wait(1).to({rotation:-0.0186,x:10.35,y:-188.05},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,rotation:-0.0249,x:10.3,y:-187.9},0).wait(1).to({rotation:-0.111,x:10.05,y:-187.8},0).wait(1).to({rotation:-0.2797,x:9.5,y:-187.6},0).wait(1).to({rotation:-0.5471,x:8.65,y:-187.3},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.8827,x:7.6,y:-186.85},0).wait(1).to({rotation:-1.1871,x:6.65,y:-186.5},0).wait(1).to({rotation:-1.3901,x:6,y:-186.25},0).wait(1).to({rotation:-1.4944,x:5.65,y:-186.05},0).wait(1).to({regX:0,regY:0,rotation:-1.5242,x:0.2,y:2.05},0).wait(1).to({regX:10.4,regY:-187.9,rotation:-1.5043,x:5.6,y:-186.05},0).wait(1).to({rotation:-1.4363,x:5.85,y:-186.15},0).wait(1).to({rotation:-1.3051,x:6.25,y:-186.35},0).wait(1).to({rotation:-1.0957,x:6.9,y:-186.6},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.8126,x:7.85,y:-186.95},0).wait(1).to({rotation:-0.5101,x:8.8,y:-187.35},0).wait(1).to({rotation:-0.2647,x:9.55,y:-187.6},0).wait(1).to({rotation:-0.1061,x:10.05,y:-187.8},0).wait(1).to({rotation:-0.0239,x:10.3,y:-187.9},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,rotation:0.0058,x:10.4,y:-187.9},0).wait(1).to({rotation:0.0246,x:10.5},0).wait(1).to({rotation:0.0583,x:10.6},0).wait(1).to({rotation:0.1097,x:10.75},0).wait(1).to({rotation:0.1814,x:11,y:-187.85},0).wait(1).to({rotation:0.2763,x:11.3},0).wait(1).to({rotation:0.3963,x:11.75},0).wait(1).to({rotation:0.5405,x:12.2,y:-187.8},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.7031,x:12.75,y:-187.7},0).wait(1).to({rotation:0.8722,x:13.35},0).wait(1).to({rotation:1.0328,x:13.9,y:-187.65},0).wait(1).to({rotation:1.1729,x:14.4},0).wait(1).to({rotation:1.2866,x:14.75,y:-187.55},0).wait(1).to({rotation:1.3735,x:15.05},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:1.4357,x:15.25},0).wait(1).to({rotation:1.4765,x:15.4},0).wait(1).to({rotation:1.499,x:15.45},0).wait(1).to({regX:0,regY:0,rotation:1.506,x:0.15,y:-0.05},0).wait(1).to({regX:10.4,regY:-187.9,rotation:1.4985,x:15.4,y:-187.55},0).wait(1).to({rotation:1.4745,x:15.35},0).wait(1).to({rotation:1.4306,x:15.2},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.3631,x:14.95},0).wait(1).to({rotation:1.2681,x:14.65},0).wait(1).to({rotation:1.142,x:14.25,y:-187.65},0).wait(1).to({rotation:0.9847,x:13.7},0).wait(1).to({rotation:0.8028,x:13.1,y:-187.7},0).wait(1).to({rotation:0.6129,x:12.4,y:-187.75},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.4359,x:11.85,y:-187.8},0).wait(1).to({rotation:0.2872,x:11.35,y:-187.85},0).wait(1).to({rotation:0.1727,x:10.95},0).wait(1).to({rotation:0.0909,x:10.7,y:-187.9},0).wait(1).to({rotation:0.0378,x:10.5},0).wait(1).to({rotation:0.0089,x:10.45},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(16).to({regX:10.4,regY:-187.9,x:10.4,y:-193.45},0).wait(1).to({y:-195.35},0).wait(1).to({regX:0,regY:0,x:0,y:-8},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-195.25},0).wait(1).to({y:-193.15},0).wait(1).to({regX:0,regY:0,x:0,y:2},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(28).to({regX:10.4,regY:-187.9,rotation:-0.0249,x:10.3,y:-187.85},0).wait(1).to({rotation:-0.111,x:10.05,y:-187.65},0).wait(1).to({rotation:-0.2797,x:9.5,y:-187.35},0).wait(1).to({rotation:-0.5471,x:8.6,y:-186.75},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-0.8827,x:7.5,y:-186},0).wait(1).to({rotation:-1.1871,x:6.5,y:-185.35},0).wait(1).to({rotation:-1.3901,x:5.85,y:-184.95},0).wait(1).to({rotation:-1.4944,x:5.5,y:-184.65},0).wait(1).to({regX:0,regY:0,rotation:-1.5242,x:0,y:3.5},0).wait(1).to({regX:10.4,regY:-187.9,rotation:-1.5046,x:5.45,y:-184.6},0).wait(1).to({rotation:-1.4376,x:5.7,y:-184.8},0).wait(1).to({rotation:-1.3084,x:6.1,y:-185.15},0).wait(1).to({rotation:-1.1021,x:6.8,y:-185.55},0).wait(1).to({rotation:-0.8232,x:7.7,y:-186.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.5252,x:8.7,y:-186.85},0).wait(1).to({rotation:-0.2835,x:9.45,y:-187.35},0).wait(1).to({rotation:-0.1272,x:10,y:-187.7},0).wait(1).to({rotation:-0.0462,x:10.25,y:-187.85},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:10.4,regY:-187.9,rotation:-0.1446,x:9.95,y:-187.65},0).wait(1).to({rotation:-0.7116,x:8.05,y:-186.45},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.3494,x:6,y:-185.05},0).wait(1).to({regX:0,regY:0,rotation:-1.5242,x:0,y:3.5},0).wait(18).to({regX:10.4,regY:-187.9,rotation:-1.466,x:5.6,y:-184.7},0).wait(1).to({rotation:-1.2487,x:6.3,y:-185.25},0).wait(1).to({rotation:-0.8232,x:7.7,y:-186.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3548,x:9.25,y:-187.2},0).wait(1).to({rotation:-0.0928,x:10.1,y:-187.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(1).to({rotation:0},0).wait(1).to({regX:10.4,regY:-187.9,rotation:-0.0879,x:10.1,y:-187.7},0).wait(1).to({rotation:-0.4284,x:9,y:-187.05},0).wait(1).to({rotation:-1.0141,x:7.1,y:-185.75},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:-1.4181,x:5.75,y:-184.85},0).wait(1).to({regX:0,regY:0,rotation:-1.5242,x:0,y:3.5},0).wait(8).to({regX:10.4,regY:-187.9,rotation:-1.466,x:5.6,y:-184.7},0).wait(1).to({rotation:-1.2487,x:6.3,y:-185.25},0).wait(1).to({rotation:-0.8232,x:7.7,y:-186.15},0).wait(1).to({scaleX:1,scaleY:1,rotation:-0.3548,x:9.25,y:-187.2},0).wait(1).to({rotation:-0.0928,x:10.1,y:-187.75},0).wait(1).to({regX:0,regY:0,rotation:-0.0227,x:0,y:0},0).wait(5).to({rotation:0},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-196.3},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-197.1},0).wait(1).to({y:-194.35},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:1},0).wait(1).to({y:0},0).wait(9).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:10.4,regY:-187.9,x:7.65,y:-180.15},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(11).to({regX:10.4,regY:-187.9,x:10.4,y:-175.65},0).wait(1).to({y:-178.6},0).wait(1).to({y:-183.55},0).wait(1).to({y:-187},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(5).to({y:-1},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-186.9},0).wait(1).to({y:-180.95},0).wait(1).to({regX:0,regY:0,x:0,y:9},0).to({y:8},2).wait(1).to({y:9},0).wait(6).to({regX:10.4,regY:-187.9,x:10.4,y:-180.1},0).wait(1).to({y:-184.4},0).wait(1).to({y:-188.7},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-188.4},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,x:10.4,y:-192.5},0).wait(1).to({regX:0,regY:0,x:0,y:-5.5},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.5},0).wait(1).to({regX:0,regY:0,x:0,y:-5.5},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.85},0).wait(1).to({y:-191.05},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).to({y:0},2).wait(1).to({x:1,y:4},1,cjs.Ease.get(1)).wait(1).to({regX:10.4,regY:-187.9,x:7.65,y:-180.15},0).wait(1).to({regX:0,regY:0,x:-4,y:9},0).to({x:0,y:13},4).wait(8).to({regX:10.4,regY:-187.9,x:10.4,y:-177.15},0).wait(1).to({y:-184.9},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:0.65},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-189.2},0).wait(1).to({regX:0,regY:0,x:0,y:-2},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-188.7},0).wait(1).to({regX:0,regY:0,x:0,y:0.65},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-187.75},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,x:10.4,y:-187.3},0).wait(1).to({y:-184.9},0).wait(1).to({y:-182.55},0).wait(1).to({regX:0,regY:0,x:0,y:6},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-182.5},0).wait(1).to({y:-182.8},0).wait(1).to({regX:0,regY:0,x:0,y:5},0).wait(5).to({regX:10.4,regY:-187.9,x:10.4,y:-183.3},0).wait(1).to({y:-184.8},0).wait(1).to({y:-187.05},0).wait(1).to({y:-188.5},0).wait(1).to({regX:0,regY:0,x:0,y:-1},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-188.15},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:0.95},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.35},0).wait(1).to({regX:0,regY:0,x:0,y:-5.5},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.95},0).wait(1).to({y:-191.45},0).wait(1).to({regX:0,regY:0,x:0,y:1.65},0).to({y:0},2).wait(9).to({regX:10.4,regY:-187.9,x:10.4,y:-195.4},0).wait(1).to({regX:0,regY:0,x:0,y:-10},0).wait(2).to({regX:10.4,regY:-187.9,x:10.4,y:-195.9},0).wait(1).to({y:-189.9},0).wait(1).to({regX:0,regY:0,x:0,y:8},0).to({y:5},2).wait(7).to({regX:10.4,regY:-187.9,x:10.4,y:-183.25},0).wait(1).to({y:-184.45},0).wait(1).to({y:-186.4},0).wait(1).to({y:-187.6},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(1).to({y:2},0).wait(1).to({y:-7},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.85},0).wait(1).to({y:-186.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({y:-7},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-192.85},0).wait(1).to({y:-186.95},0).wait(1).to({regX:0,regY:0,x:0,y:3},0).wait(1).to({regX:10.4,regY:-187.9,x:10.4,y:-187},0).wait(1).to({y:-187.65},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(2).to({regX:10.4,regY:-187.9,x:13.4,y:-184.5},0).wait(1).to({regX:0,regY:0,x:4,y:4.55},0).to({x:-2,y:8.8},2).wait(1).to({regX:10.4,regY:-187.9,x:9.55,y:-178.45},0).wait(1).to({x:10.2,y:-178.05},0).wait(1).to({regX:0,regY:0,x:0,y:10},0).wait(5).to({regX:10.4,regY:-187.9,x:10.4,y:-178.6},0).wait(1).to({y:-181.05},0).wait(1).to({y:-184.75},0).wait(1).to({y:-187.25},0).wait(1).to({regX:0,regY:0,x:0,y:0},0).wait(11).to({regX:10.4,regY:-187.9,rotation:0.0246,x:10.5,y:-187.9},0).wait(1).to({rotation:0.1097,x:10.75,y:-187.8},0).wait(1).to({rotation:0.2763,x:11.3,y:-187.5},0).wait(1).to({rotation:0.5405,x:12.2,y:-187.1},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:0.8722,x:13.35,y:-186.55},0).wait(1).to({rotation:1.1729,x:14.4,y:-186.1},0).wait(1).to({rotation:1.3735,x:15.05,y:-185.7},0).wait(1).to({scaleX:0.9998,scaleY:0.9998,rotation:1.4765,x:15.4,y:-185.55},0).wait(1).to({regX:0,regY:0,rotation:1.506,x:0.15,y:2.05},0).wait(1).to({regX:10.4,regY:-187.9,rotation:1.4863,x:15.35,y:-185.55},0).wait(1).to({scaleX:0.9999,scaleY:0.9999,rotation:1.4191,x:15.15,y:-185.65},0).wait(1).to({rotation:1.2895,x:14.75,y:-185.8},0).wait(1).to({rotation:1.0826,x:14,y:-186.2},0).wait(1).to({rotation:0.8028,x:13.1,y:-186.65},0).wait(1).to({scaleX:1,scaleY:1,rotation:0.504,x:12.05,y:-187.15},0).wait(1).to({rotation:0.2616,x:11.25,y:-187.5},0).wait(1).to({rotation:0.1048,x:10.75,y:-187.8},0).wait(1).to({rotation:0.0236,x:10.45,y:-187.9},0).wait(1).to({regX:0,regY:0,rotation:0,x:0,y:0},0).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-381.3,-708.8,813.5,883.9);
...
// stage content:
(lib._482_2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end0:14,scene1:15,end1:133,scene2:134,end2:285,scene3:286,end3:442,scene4:443,end4:612,scene5:613,end5:782,scene6:783,end6:927,scene7:928,end7:1064});
	...
	this.frame_315 = function() {
		exportRoot._g.m1 = this.m.t[exportRoot._g.idx][1];
		exportRoot._g.m2 = "ﾃﾞｭｰｻｰちゃん!";
		exportRoot._u.setText();
	}
	this.frame_338 = function() {
		exportRoot._g.m2 = this.m.t[exportRoot._g.idx][2];
		exportRoot._g.m3 = "しないの?";
		exportRoot._u.setText();
	...
	this.frame_479 = function() {
		exportRoot._g.m1 = "もしかして……ｷﾝﾁｮｰしてる?";
		exportRoot._u.setText();
	...
	this.frame_694 = function() {
		exportRoot._g.m2 = "らいっぱい見てｲｲし☆ゆい､";
		exportRoot._u.setText();
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(14).call(this.frame_14).wait(1).call(this.frame_15).wait(21).call(this.frame_36).wait(29).call(this.frame_65).wait(24).call(this.frame_89).wait(21).call(this.frame_110).wait(23).call(this.frame_133).wait(1).call(this.frame_134).wait(44).call(this.frame_178).wait(60).call(this.frame_238).wait(26).call(this.frame_264).wait(21).call(this.frame_285).wait(1).call(this.frame_286).wait(19).call(this.frame_305).wait(10).call(this.frame_315).wait(23).call(this.frame_338).wait(30).call(this.frame_368).wait(24).call(this.frame_392).wait(39).call(this.frame_431).wait(11).call(this.frame_442).wait(1).call(this.frame_443).wait(36).call(this.frame_479).wait(18).call(this.frame_497).wait(12).call(this.frame_509).wait(13).call(this.frame_522).wait(25).call(this.frame_547).wait(24).call(this.frame_571).wait(25).call(this.frame_596).wait(16).call(this.frame_612).wait(1).call(this.frame_613).wait(29).call(this.frame_642).wait(23).call(this.frame_665).wait(29).call(this.frame_694).wait(8).call(this.frame_702).wait(13).call(this.frame_715).wait(25).call(this.frame_740).wait(13).call(this.frame_753).wait(29).call(this.frame_782).wait(1).call(this.frame_783).wait(8).call(this.frame_791).wait(17).call(this.frame_808).wait(24).call(this.frame_832).wait(14).call(this.frame_846).wait(35).call(this.frame_881).wait(19).call(this.frame_900).wait(12).call(this.frame_912).wait(15).call(this.frame_927).wait(1).call(this.frame_928).wait(16).call(this.frame_944).wait(30).call(this.frame_974).wait(29).call(this.frame_1003).wait(24).call(this.frame_1027).wait(37).call(this.frame_1064).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.sender).wait(1064).to({_off:false},0).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.loader).wait(1069));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:0.1992},3,cjs.Ease.get(1)).to({_off:true},1).wait(1050));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({_off:false},0).to({_off:true},3).wait(1054));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({alpha:0.1016},3).to({_off:true},1).wait(1050));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_1).wait(15).to({y:301.1},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:398.6},0).wait(1).to({y:394.65},0).wait(1).to({y:388},0).wait(1).to({y:378.75},0).wait(1).to({y:367.25},0).wait(1).to({y:354.25},0).wait(1).to({y:340.85},0).wait(1).to({y:328.45},0).wait(1).to({y:318.45},0).wait(1).to({y:312},0).wait(1).to({regX:0,regY:0,x:2,y:211},0).wait(1).to({regX:132.8,regY:98.8,x:134.8,y:310.3},0).wait(1).to({y:311.9},0).wait(1).to({regX:0,regY:0,x:2,y:214},0).wait(963).to({regX:132.8,regY:98.8,x:134.8,y:313.9},0).wait(1).to({y:317.75},0).wait(1).to({y:325},0).wait(1).to({y:336.4},0).wait(1).to({y:351.7},0).wait(1).to({y:368.85},0).wait(1).to({y:384.15},0).wait(1).to({y:395.55},0).wait(1).to({y:402.8},0).wait(1).to({y:406.65},0).wait(1).to({regX:0,regY:0,x:2,y:309},0).to({_off:true},1).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.window_2).wait(1003).to({_off:false},0).wait(1).to({regX:16.8,regY:-1.3,x:136.8,y:320.2},0).wait(1).to({y:318.5},0).wait(1).to({y:315.2},0).wait(1).to({y:309.85},0).wait(1).to({y:302.4},0).wait(1).to({y:294.05},0).wait(1).to({y:287.1},0).wait(1).to({y:282.55},0).wait(1).to({y:280.25},0).wait(1).to({regX:0,regY:0,x:120,y:280.9},0).to({y:282.9},3).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1003).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.glitters).wait(1003).to({_off:false},0).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.fns).wait(1003).to({_off:false},0).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(991).to({_off:false},0).to({alpha:0.8984},11).to({_off:true},1).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(928).to({_off:false},0).to({alpha:0},7).to({_off:true},1).wait(133));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_12},{t:this.instance_11}]}).to({state:[]},15).wait(1054));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt).wait(315).to({_off:false},0).to({alpha:1},23).wait(454).to({alpha:0},11).to({_off:true},1).wait(265));
	...
	this.timeline.addTween(cjs.Tween.get(this.lighter_tgt_1).wait(315).to({_off:false},0).to({alpha:0.4492},23).wait(454).to({alpha:0},11).to({_off:true},1).wait(265));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({_off:false},0).to({_off:true},988).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.ch1).wait(15).to({regX:0.1,regY:0.3,scaleX:0.517,scaleY:0.517,x:107.15,y:240.45},0).to({regX:0,regY:0.2,scaleX:0.5067,scaleY:0.5067,x:107.5,y:237.3},17,cjs.Ease.quadInOut).wait(54).to({scaleX:0.6344,scaleY:0.6344,x:103.1,y:281.6},21,cjs.Ease.quadInOut).wait(208).to({regX:0.1,regY:0.3,scaleX:0.7975,scaleY:0.7975,x:97.25,y:347.85},23,cjs.Ease.quadInOut).wait(105).to({regX:0.2,regY:0.6,scaleX:0.7605,scaleY:0.7605,x:98.35,y:334.6},17,cjs.Ease.quadInOut).wait(293).to({regX:0.1,regY:0.4,scaleX:0.814,scaleY:0.814,x:96.4,y:351.9},16,cjs.Ease.quadInOut).wait(23).to({scaleX:0.6815,scaleY:0.6815,x:101.25,y:304.65},11,cjs.Ease.quadInOut).to({_off:true},125).wait(141));

	// ch2
	this.ch2 = new lib.character1_container();
	this.ch2.name = "ch2";
	this.ch2.parent = this;
	this.ch2.setTransform(113.3,232.7,0.4795,0.4795,0,0,0,0.2,0.5);

	this.timeline.addTween(cjs.Tween.get(this.ch2).to({_off:true},15).wait(912).to({_off:false,x:413.3},0).wait(1).to({regX:0.3,scaleX:0.4945,scaleY:0.4945,x:108.95,y:234.25},0).to({_off:true},75).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg1).wait(15).to({regX:-0.2,scaleX:0.517,scaleY:0.517,x:-19.35,y:-37.7},0).to({regY:0.1,scaleX:0.5067,scaleY:0.5067,x:-16.45,y:-35.25},17,cjs.Ease.quadInOut).wait(54).to({scaleX:0.6344,scaleY:0.6344,x:-52.1,y:-59.65},21,cjs.Ease.quadInOut).wait(208).to({regX:-0.3,regY:0,scaleX:0.7975,scaleY:0.7975,x:-97.9,y:-81.2},23,cjs.Ease.quadInOut).wait(105).to({regX:-0.6,regY:-0.2,scaleX:0.7605,scaleY:0.7605,x:-87.7,y:-74.55},17,cjs.Ease.quadInOut).wait(293).to({regX:-0.5,regY:-0.1,scaleX:0.814,scaleY:0.814,x:-102.75,y:-86.05},16,cjs.Ease.quadInOut).wait(23).to({scaleX:0.6815,scaleY:0.6815,x:-65.5,y:-61.95},11,cjs.Ease.quadInOut).wait(125).to({regX:-0.4,regY:-0.2,scaleX:0.4945,scaleY:0.4945,x:-12,y:-31.75},0).to({_off:true},75).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.toggle_btn).to({_off:true},991).wait(78));
	...
	this.timeline.addTween(cjs.Tween.get(this.stage_btn).to({_off:true},1003).wait(61).to({_off:false},0).wait(5));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-282,-720,927.8,1371.1);
// library properties:
lib.properties = {
	id: '_482_2',
	width: 240,
	...
	opacity: 1.00,
	manifest: [
		{src:"images/bg.jpg?1651022894759", id:"_482_2_bg"},
		{src:"images/book.png?1651022894759", id:"_482_2_book"},
		{src:"images/ch_base.png?1651022894759", id:"_482_2_ch_base"},
		{src:"images/ch_face2.png?1651022894759", id:"_482_2_ch_face2"},
		{src:"images/ch_face3.png?1651022894759", id:"_482_2_ch_face3"},
		{src:"images/ch_face4.png?1651022894759", id:"_482_2_ch_face4"},
		{src:"images/ch_face5.png?1651022894759", id:"_482_2_ch_face5"},
		{src:"images/ch_face6.png?1651022894759", id:"_482_2_ch_face6"},
		{src:"images/ch_face7.png?1651022894759", id:"_482_2_ch_face7"},
		{src:"images/ch_face8.png?1651022894759", id:"_482_2_ch_face8"},
		{src:"images/ch_face9.png?1651022894759", id:"_482_2_ch_face9"},
		{src:"images/finish.jpg?1651022894759", id:"_482_2_finish"},
		{src:"images/finish_blur.jpg?1651022894759", id:"_482_2_finish_blur"},
		{src:"images/tie_fp.png?1651022894759", id:"_482_2_tie_fp"},
		{src:"images/tie_sp.png?1651022894759", id:"_482_2_tie_sp"}
	],
	preloads: []
};
